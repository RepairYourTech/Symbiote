...
export interface ExtensionStateContextType extends ExtensionState {
	...
	setShowSymbioteIgnoredFiles: (value: boolean) => void
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		showSymbioteIgnoredFiles: true, // Default to showing .symbiote-ignore'd files with lock symbol (current behavior).
	...
	const contextValue: ExtensionStateContextType = {
		...
		setShowSymbioteIgnoredFiles: (value) => setState((prevState) => ({ ...prevState, showSymbioteIgnoredFiles: value })),
