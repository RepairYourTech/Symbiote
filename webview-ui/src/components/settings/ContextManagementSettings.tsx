...
type ContextManagementSettingsProps = HTMLAttributes<HTMLDivElement> & {
	...
	setCachedStateField: SetCachedStateField<
		"maxOpenTabsContext" | "maxWorkspaceFiles" | "showSymbioteIgnoredFiles" | "maxReadFileLine"
	>
}
	...
	return (
		<div className={cn("flex flex-col gap-2", className)} {...props}>
			...
			<Section>
				...
				<div>
					<VSCodeCheckbox
						checked={showSymbioteIgnoredFiles}
						onChange={(e: any) => setCachedStateField("showSymbioteIgnoredFiles", e.target.checked)}
						data-testid="show-symbiote-ignored-files-checkbox">
						<label className="block font-medium mb-1">
							{t("settings:contextManagement.symbioteIgnore.label")}
						</label>
					</VSCodeCheckbox>
					<div className="text-vscode-descriptionForeground text-sm mt-1">
						{t("settings:contextManagement.symbioteIgnore.description")}
					</div>
				</div>
