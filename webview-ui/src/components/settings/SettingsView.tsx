...
const SettingsView = forwardRef<SettingsViewRef, SettingsViewProps>(({ onDone, targetSection }, ref) => {
	...
	const setTelemetrySetting = useCallback((setting: TelemetrySetting) => {
		// In Symbiote, telemetry is always disabled regardless of user settings
		const actualSetting: TelemetrySetting = "disabled"
		setCachedState((prevState) => {
			if (prevState.telemetrySetting === actualSetting) {
				return prevState
			}

			setChangeDetected(true)
			return { ...prevState, telemetrySetting: actualSetting }
		})
	}, [])
	...
	const handleSubmit = () => {
		if (isSettingValid) {
			...
			vscode.postMessage({ type: "showSymbioteIgnoredFiles", bool: showSymbioteIgnoredFiles })
			...
			<TabContent className="p-0 divide-y divide-vscode-sideBar-background">
				...
				<div ref={contextManagementRef}>
					<ContextManagementSettings
						...
						showSymbioteIgnoredFiles={showSymbioteIgnoredFiles}
