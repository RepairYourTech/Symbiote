...
export const globalSettingsSchema = z.object({
	...
	showSymbioteIgnoredFiles: z.boolean().optional(),
...
const globalSettingsRecord: GlobalSettingsRecord = {
	...
	showSymbioteIgnoredFiles: undefined,
...
export const symbioteSettingsSchema = providerSettingsSchema.merge(globalSettingsSchema)

export type SymbioteSettings = GlobalSettings & ProviderSettings
...
export type GlobalState = Omit<SymbioteSettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<SymbioteSettings>) => !SECRET_STATE_KEYS.includes(key as Keys<SecretState>),
) as Keys<GlobalState>[]
...
export const symbioteEventsSchema = z.object({
	[SymbioteEventName.Message]: z.tuple([
		z.object({
			taskId: z.string(),
	...
	[SymbioteEventName.TaskCreated]: z.tuple([z.string()]),
	[SymbioteEventName.TaskStarted]: z.tuple([z.string()]),
	[SymbioteEventName.TaskModeSwitched]: z.tuple([z.string(), z.string()]),
	[SymbioteEventName.TaskPaused]: z.tuple([z.string()]),
	[SymbioteEventName.TaskUnpaused]: z.tuple([z.string()]),
	[SymbioteEventName.TaskAskResponded]: z.tuple([z.string()]),
	[SymbioteEventName.TaskAborted]: z.tuple([z.string()]),
	[SymbioteEventName.TaskSpawned]: z.tuple([z.string(), z.string()]),
	[SymbioteEventName.TaskCompleted]: z.tuple([z.string(), tokenUsageSchema, toolUsageSchema]),
	[SymbioteEventName.TaskTokenUsageUpdated]: z.tuple([z.string(), tokenUsageSchema]),
})

export type SymbioteEvents = z.infer<typeof symbioteEventsSchema>
...
export const typeDefinitions: TypeDefinition[] = [
	...
	{ schema: symbioteEventsSchema, identifier: "SymbioteEvents" },
]
