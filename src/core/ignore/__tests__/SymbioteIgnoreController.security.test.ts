// npx jest src/core/ignore/__tests__/SymbioteIgnoreController.security.test.ts
...
describe("SymbioteIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .symbiote-ignore to exist with some patterns
