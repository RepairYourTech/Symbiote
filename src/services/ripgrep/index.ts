...
export async function regexSearchFiles(
	...
	// Filter results using SymbioteIgnoreController if provided
	const filteredResults = symbioteIgnoreController
		? results.filter((result) => symbioteIgnoreController.validateAccess(result.file))
		: results
